...
@JsonKey(name: 'id') String? get id;@JsonKey(name: 'id_user') String? get idUser;@JsonKey(name: 'username') String? get username;@JsonKey(name: 'nama_lengkap') String? get nameLengkap;@JsonKey(name: 'nama_panggilan') String? get namaPanggilan;@JsonKey(name: 'email') String? get email;@JsonKey(name: 'email_verified_at') DateTime? get emailVerifiedAt;@JsonKey(name: 'google_id') String? get googleId;@JsonKey(name: 'asal_sekolah') String? get asalSekolah;@JsonKey(name: 'kelas_jurusan') String? get kelasJurusan;@JsonKey(name: 'level') String? get level;@JsonKey(name: 'foto') String? get foto;
...
@useResult
$Res call({
@JsonKey(name: 'id') String? id,@JsonKey(name: 'id_user') String? idUser,@JsonKey(name: 'username') String? username,@JsonKey(name: 'nama_lengkap') String? nameLengkap,@JsonKey(name: 'nama_panggilan') String? namaPanggilan,@JsonKey(name: 'email') String? email,@JsonKey(name: 'email_verified_at') DateTime? emailVerifiedAt,@JsonKey(name: 'google_id') String? googleId,@JsonKey(name: 'asal_sekolah') String? asalSekolah,@JsonKey(name: 'kelas_jurusan') String? kelasJurusan,@JsonKey(name: 'level') String? level,@JsonKey(name: 'foto') String? foto
});
