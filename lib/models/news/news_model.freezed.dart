...
/// Create a copy of NewsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? idBerita = freezed,Object? idKategori = freezed,Object? idUser = freezed,Object? judul = freezed,Object? isiBerita = freezed,Object? gambar = freezed,Object? tanggal = freezed,Object? counter = freezed,Object? jenisBerita = freezed,Object? namaLengkap = freezed,Object? namaKategori = freezed,Object? kategori = freezed,Object? user = freezed,}) {
...
as String?,namaKategori: freezed == namaKategori ? _self.namaKategori : namaKategori // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_berita')  String? idBerita, @JsonKey(name: 'id_kategori')  String? idKategori, @JsonKey(name: 'id_user')  String? idUser, @JsonKey(name: 'judul')  String? judul, @JsonKey(name: 'isi_berita')  String? isiBerita, @JsonKey(name: 'gambar')  String? gambar, @JsonKey(name: 'tanggal')  DateTime? tanggal, @JsonKey(name: 'counter')  String? counter, @JsonKey(name: 'jenis_berita')  String? jenisBerita, @JsonKey(name: 'namaLengkap')  String? namaLengkap, @JsonKey(name: 'namaKategori')  String? namaKategori, @JsonKey(name: 'kategori')  KategoriModel? kategori, @JsonKey(name: 'user')  UserModel? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewsModel() when $default != null:
return $default(_that.idBerita,_that.idKategori,_that.idUser,_that.judul,_that.isiBerita,_that.gambar,_that.tanggal,_that.counter,_that.jenisBerita,_that.namaLengkap,_that.namaKategori,_that.kategori,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id_berita')  String? idBerita, @JsonKey(name: 'id_kategori')  String? idKategori, @JsonKey(name: 'id_user')  String? idUser, @JsonKey(name: 'judul')  String? judul, @JsonKey(name: 'isi_berita')  String? isiBerita, @JsonKey(name: 'gambar')  String? gambar, @JsonKey(name: 'tanggal')  DateTime? tanggal, @JsonKey(name: 'counter')  String? counter, @JsonKey(name: 'jenis_berita')  String? jenisBerita, @JsonKey(name: 'namaLengkap')  String? namaLengkap, @JsonKey(name: 'namaKategori')  String? namaKategori, @JsonKey(name: 'kategori')  KategoriModel? kategori, @JsonKey(name: 'user')  UserModel? user)  $default,) {final _that = this;
switch (_that) {
case _NewsModel():
return $default(_that.idBerita,_that.idKategori,_that.idUser,_that.judul,_that.isiBerita,_that.gambar,_that.tanggal,_that.counter,_that.jenisBerita,_that.namaLengkap,_that.namaKategori,_that.kategori,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey(name: 'namaLengkap') final  String? namaLengkap;
@override@JsonKey(name: 'namaKategori') final  String? namaKategori;
...
/// Create a copy of NewsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? idBerita = freezed,Object? idKategori = freezed,Object? idUser = freezed,Object? judul = freezed,Object? isiBerita = freezed,Object? gambar = freezed,Object? tanggal = freezed,Object? counter = freezed,Object? jenisBerita = freezed,Object? namaLengkap = freezed,Object? namaKategori = freezed,Object? kategori = freezed,Object? user = freezed,}) {
